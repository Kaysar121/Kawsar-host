...
UPDATE_CHANNEL_URL = "https://t.me/kawsar93400"
...
🚀 <b>1-Click Deployment</b>
Upload <code>.py</code> or <code>.zip</code> and go live instantly.

🎛 <b>Full Project Control</b>
Start ▶️ | Stop 🛑 | Restart 🔄 | Logs 📝 | Status 📈

⚙️ <b>Auto Dependency Installer</b>
Smart <code>requirements.txt</code> detection & auto install.

📊 <b>Live Monitoring</b>
Track CPU ⚡ & RAM 🧠 usage in real-time.

🔐 <b>Secure Virtual Environment</b>
Each project runs safely & isolated.
...
━━━━━━━━━━━━━━━━━━
👇 <b>Start Deploying Now</b>
Use /newproject to launch your first app 🚀
"""
...
async def web_server():
    ...
    await site.start()
    logger.info("🌐 Web server started on port {}".format(os.environ.get("PORT", 10000)))
